...
import { withNavigate } from '../../utilities/withNavigate';
import { withParams } from "../../utilities/withParams";
    ...
    handleUpdateButtonPressed() {
        const requestOptions = {
            ...
            body: JSON.stringify({
                votes_to_skip: this.state.votesToSkip,
                guest_can_pause: this.state.guestCanPause,
                code: this.props.params.roomCode,
            }),
        };
...
export default withParams(withNavigate(CreateRoomPage));